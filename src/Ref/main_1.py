...
from QueryExpansion import BoolQueryExpansion, CombinedQuery, ExapnsionScore_2016, Queryexpansion, QueryExpansion_2016, \
    QueryExpansionList
from Ref import Corpus, OkapiBm25,Bm25_scoring
...
class Main:
    ...
    def ExtractBaseLineScoresFromFiles_2019(self, and_file, or_file, out_file):
        ...
        save_obj = SaveCombineQueryExapansionScore.SaveCombineQueryExapnsion(out_file, extract_and_results,
                                                                             extract_or_results)
    ...
    def getFilterMetamapBoolQueryscore_2016(self, out_file):
        ...
        _ = SaveScore2016.SaveScore_2016(score_res, query_id,
                                         out_file)  # "/home/junhua/trec/Trec2021/Output/Filter_Summary_AND_Metamap_BoolQuery_scores_2016.csv"
        print("Summary scores saved successfully")
    ...
    def combineBothCombineFiles_2016(self):
        self.ExtractNERBaseLineScoresFromFiles_2016(
            '/home/junhua/trec/Trec2021/Output/New_Summary_Combined_NER_BoolQuery_scores_2016.csv',
    ...
    def perform_TREC_2016(self):
        ...
        self.GetNERMetamapBoolQueryscore_2016(
            ...
            '/home/junhua/trec/Trec2021/Output/New_Summary_AND_NER-BERN_Query2016_gene-disease-drug_2016.csv',
            '/home/junhua/trec/Trec2021/Output/New_Summary_OR_NER-BERN_Query2016_gene-disease-drug_2016.csv',
            "NER-Drug")
        self.ExtractNERBaseLineScoresFromFiles_2016(
            '/home/junhua/trec/Trec2021/Output/New_Summary_AND_NER-BERN_Query2016_gene-disease-drug_2016.csv',
            '/home/junhua/trec/Trec2021/Output/New_Summary_OR_NER-BERN_Query2016_gene-disease-drug_2016.csv',
        ...
        self.GetNERMetamapBoolQueryscore_2016(
            '/home/junhua/trec/Trec2021/Data/2016_Quries/NER-BERN_Query2016_gene-disease.csv',
            '/home/junhua/trec/Trec2021/Output/New_Summary_AND_NER-BERN_Query2016_gene-disease_2016.csv',
            '/home/junhua/trec/Trec2021/Output/New_Summary_OR_NER-BERN_Query2016_gene-disease_2016.csv', "NER-Disease")
        self.ExtractNERBaseLineScoresFromFiles_2016(
            '/home/junhua/trec/Trec2021/Output/New_Summary_AND_NER-BERN_Query2016_gene-disease_2016.csv',
            '/home/junhua/trec/Trec2021/Output/New_Summary_OR_NER-BERN_Query2016_gene-disease_2016.csv',
            '/home/junhua/trec/Trec2021/Output/New_Summary_Combined_NER-BERN_Query2016_gene-disease_2016.csv')

        self.GetNERMetamapBoolQueryscore_2016('/home/junhua/trec/Trec2021/Data/2016_Quries/NER-BERN_Query2016_all.csv',
                                              '/home/junhua/trec/Trec2021/Output/New_Summary_AND_NER-BERN_Query2016_all.csv',
                                              '/home/junhua/trec/Trec2021/Output/New_Summary_OR_NER-BERN_Query2016_all.csv',
                                              "NER-All")
        self.ExtractNERBaseLineScoresFromFiles_2016(
            '/home/junhua/trec/Trec2021/Output/New_Summary_AND_NER-BERN_Query2016_all.csv',
            '/home/junhua/trec/Trec2021/Output/New_Summary_OR_NER-BERN_Query2016_all.csv',
            '/home/junhua/trec/Trec2021/Output/New_Summary_Combined_New_Summary_OR_NER-BERN_Query2016_all.csv')

        self.GetNERMetamapBoolQueryscore_2016(
            '/home/junhua/trec/Trec2021/Data/2016_Quries/KeywordExtr_Query2016_5w-1gram.csv',
            '/home/junhua/trec/Trec2021/Output/Summary_AND_5w-1gram_2016.csv',
            '/home/junhua/trec/Trec2021/Output/Summary_OR_5w-1gram_2016.csv', "Weighted")
        self.ExtractNERBaseLineScoresFromFiles_2016('/home/junhua/trec/Trec2021/Output/Summary_AND_5w-1gram_2016.csv',
                                                    '/home/junhua/trec/Trec2021/Output/Summary_OR_5w-1gram_2016.csv',
                                                    '/home/junhua/trec/Trec2021/Output/Summary_Combined_5w-1gram_2016.csv')
    ...
    def getExapnsionQueries_2016(self, source_file, type):
        ...
        if type == "Manual":
            obj = QueryExpansion_2016.ExapandedQuery_2016(source_file,
                                                          ['queryID', 'summary', 'summary_keyword',
    ...
    def getQueryExapansionscore_2016(self, query_file, and_out_file, or_out_file, query_type, type, out_file="",
                                     index=0):
    ...
    def getQueryExapansionscore_2021(self, query_file, and_out_file, or_out_file, query_type, type, out_file="",
                                     index=0):
        ...
        score_obj = ExapnsionScore_2016.GetQueryExapnsionScore_2016(query_expansion_list, id_list,
                                                                    "2021-trec-precision-medicine-final")
        results = score_obj.getExpansionScores_2021(index, out_file)
    ...
    def evaluation(self):
        obj = Evaluation.GetDuplicates(
            '/home/junhua/trec/Trec2021/Output/combined_rerank_cross_output_f5k_OR_rawq_2k-1.csv')
...
if __name__ == '__main__':
    ...
    for i in range(1, 76):
        main_obj.query_exapansion_scores_2021('/home/junhua/trec/Trec2021/Data/2021Quries/raw-exp_manualKW_joined_1-75_B-reformated.csv',
                                              "Manual",
                                              '/home/junhua/trec/Trec2021/Output/Query_expansion_Combinational_1-1000_score_2021' + str(
                                                  i) + '.csv',
                                              i)
    ...
    main_obj.query_exapansion_scores_2016('./Data/2016_Quries/Manual_KeywordExtr_Query2016_aug3_B-reformated.csv',
     ...
     main_obj.query_exapansion_scores_2016('./Data/2016_Quries/Manual_KeywordExtr_Query2016_aug3_B-reformated.csv',
                                          "Manual",
                                          '/home/junhua/trec/Trec2021/Output/Final_Expansion_combinational_score_2016_query_exp_26.csv',
                                          25)
