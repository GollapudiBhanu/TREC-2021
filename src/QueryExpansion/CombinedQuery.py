...
class GetCombinedBoolQuery:
    ...
    '''
        input:
            search_index: Index where we need to search the queries
        Description:
            it prepares quries by combining them with "AND" and "OR".
        Output:
            combined query results for and_query_results,or_query_results
